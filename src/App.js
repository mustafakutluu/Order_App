...
const App = () => {
    ...
    useEffect(() => {
        if (mobileMenuActive) {
            ...
            addClass(document.head, "body-overflow-hidden");
        } else {
    ...
    return (
        <div className={wrapperClass} onClick={onWrapperClick}>
            ...
            <AppTopbar onToggleMenuClick={onToggleMenuClick} layoutColorMode={layoutColorMode}
                mobileTopbarMenuActive={mobileTopbarMenuActive} logout={logout} onMobileSubTopbarMenuClick={onMobileSubTopbarMenuClick} />
